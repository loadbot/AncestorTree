...
- **Feed bài viết** - Chia sẻ ảnh quê hương, kỷ niệm, tin vui, thông báo (5 loại bài)
- **Bình luận** - Bình luận trực tiếp trên bài viết (flat, không nested)
- **Thả tim** - Like/unlike bài viết, đếm số lượt thích
- **Upload ảnh** - Tối đa 5 ảnh/bài viết, grid layout tự động
- **Lọc theo loại** - Tabs: Tất cả / Ảnh / Tin vui / Kỷ niệm / Thông báo
- **Moderation** - Admin/editor ẩn/hiện/xoá bài viết vi phạm
- **Desktop support** - Hoạt động offline trên bản Desktop (SQLite)
...
v2.5.0 Feed      [##########] Done - Góc giao lưu (bài viết + bình luận + thả tim)
v2.6.0 GEDCOM    [----------] Next - GEDCOM 7.0 Export + Phát hiện trùng lặp + Chế độ người cao tuổi
v2.7.0 Search    [----------] Plan - Tìm quan hệ + Thống kê + Xuất PDF
v2.8.0 Notify    [----------] Plan - Thông báo realtime
v3.0.0 Community [----------] Future - Nhà thờ họ, Cross-clan
```
